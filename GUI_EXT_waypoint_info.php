...
//
// $Id: GUI_EXT_waypoint_info.php,v 1.7 2010/03/14 20:56:10 manolis Exp $                                                                 
//
//************************************************************************
...
<? if ($wpLocation || $wpInfo->description || $wpInfo->link) { ?>
	 <br>
      <table class="Box"  align="center" width="100%">
		...
		<? if ($wpLocation) { ?>
        <tr bgcolor="#F2ECDB">
          <td width=100><? echo _SITE_REGION ?></td>
   ...
   <? if ($weatherResponse==200) { ?>
        <tr bgcolor="#F2ECDB">
		  <td></td>
                  ...
                  <td colspan=2 valign="top">
                         <a href="<? echo getLeonardoLink(array('op'=>'list_detailed_forecasts','takeoff'=>$waypointIDview))?>"><button style="width:120px;height:32px"><? echo _SHORT_TERM ?></button></a>
                <a href="<? echo getLeonardoLink(array('op'=>'list_forecasts','takeoff'=>$waypointIDview))?>"><button style="width:120px;height:32px"><? echo _LONG_TERM ?></button></a>
                  </td>
...
<!-- extended description ends here-->
        ...
        <tr bgcolor="#F2ECDB">
          <td width=100><? echo _SITE_DESCR ?></td>
      ...
      <table class="Box" width="100%"  align="center">
        <tr >
          <td width="50%" rowspan="4" valign="top"><img src="<? echo $moduleRelPath ?>/EXT_showWaypointGlobe.php?type=big&zoomFactor=2&lat=<? echo $wpInfo->lat ?>&lon=<? echo $wpInfo->lon ?>" ></td>
