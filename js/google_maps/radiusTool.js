...
queryCenterOptions.icon.image = "https://files.leonardo.pgxc.pl/centerArrow.png";
...
queryLineOptions.icon.image = "https://files.leonardo.pgxc.pl/resizeArrow.png";
...
GeoQuery.prototype.getDistHtml = function() {
  result = "<img src='https://files.leonardo.pgxc.pl/close.gif' onClick='myQueryControl.remove(" + this._control.getIndex(this) + ");'/>Radius ";
   result = "Radius ";
