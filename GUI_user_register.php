...
//20160203
			...
			LeonardoMail::sendMail('[Leonardo] - Confirmation email',$email_body,$r['user_email'],addslashes($_POST['firstname']));
			unset($actkey);
...
var _MANDATORY_STATUTE='<?=_MANDATORY_STATUTE?>';
            ...
            <td width="350" class="TextoP"><select name="nation" id="nation" class="TextoVermelho" readonly="readonly"/>
              ...
              <?php
				...
				?>
                  ...
                  <tr>
          <td width="250" align="right" class="TextoP"><?=_ACCEPT_STATUTE;?></td>
            <td width="350" class="TextoP"><input type="checkbox" name="statute" id="statute" class="TextoVermelho" value="1">
