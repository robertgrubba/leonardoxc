...
?>
<li class="smallItem short hideOnSmall hideOnExtraSmall"><a class="smallItem"  href='#'><?=$current_flagImg?></a>
	<ul class="short" >
...
<li><a href="#"><?=_MENU_TAKEOFFS." ".$arrDownImg ?></a>
	<ul>
		...
		<li><a href="<?=getLeonardoLink(array('op'=>'list_detailed_forecasts','country'=>'PL') )?>"><?=_MENU_SHORT_TERM_FORECASTS ?></a></li>
		<li><a href="<?=getLeonardoLink(array('op'=>'list_forecasts','country'=>'PL') )?>"><?=_MENU_FORECASTS ?></a></li>
	</ul>
</li>
...
<li class="long"> <a href="http://trac.pgxc.pl/newticket" target="_blank"><?= _TICKET_SYS ?></a></li>
</ul>
