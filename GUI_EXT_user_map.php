...
//        getAjax('https://leonardo.pgxc.pl/startowisko/'+id,null,openMarkerInfoWindow);
        window.open('https://leonardo.pgxc.pl/startowisko/'+id,'_blank');
		// jQuery.facebox(
		// 	function() {
...
<? if(0) { ?>
 ...
 <? } ?>	
	...
	getAjax('EXT_takeoff.php?op=get_user_takeoffs&userID=<?=$userID?>',null,drawTakeoffs);
