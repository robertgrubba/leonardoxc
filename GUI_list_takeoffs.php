...
//
// $Id: GUI_list_takeoffs.php,v 1.34 2010/03/14 20:56:11 manolis Exp $                                                                 
//
//************************************************************************
...
$takeoffName=file_get_contents('http://weather:8080/isflyabletoday/1/'.$row["intName"])." ".showWaypointDesciptionIcon($row["takeoffID"])." ".$takeoffName;
